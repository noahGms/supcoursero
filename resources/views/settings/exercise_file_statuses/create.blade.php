...
@section('content')
    <div class="container px-5 py-5 mx-auto">
        <div class="flex items-center mb-4">
            ...
            <h1 class="text-xl mb-0">Add new exercise file status</h1>
        </div>

        <form action="{{route('exercise-file-statuses.store')}}" method="post" class="h-full">
            @csrf
            ...
            <div class="mt-6">
                ...
                <input required type="text" id="color" name="color" value="{{old('color')}}" class="bg-gray-200 border rounded  text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2 @error('color') border-red-500 @enderror"/>
                @if($errors->has('color'))
